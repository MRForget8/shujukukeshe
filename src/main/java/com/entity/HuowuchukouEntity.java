...
public class HuowuchukouEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public HuowuchukouEntity() {
		
	}
	
	public HuowuchukouEntity(T t) {
		try {
	 ...
	 * 设置：出口时间
	 */
	public void setChukoushijian(Date chukoushijian) {
		this.chukoushijian = chukoushijian;
	}
	/**
	 * 获取：出口时间
	 */
	public Date getChukoushijian() {
		return chukoushijian;
	}
	/**
	 * 设置：交接人
	 */
